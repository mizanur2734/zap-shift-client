import { FaTruck, FaGlobe, FaBoxOpen, FaMoneyBillWave, FaHandshake, FaUndo } from "react-icons/fa";
...
const services = [
  ...
  {
    title: "Parcel Return",
    description: "Through our reverse logistics facility we allow easy customers to return or exchange their products with online business merchants.",
...
const Services = () => {
  return (
    <section className="bg-[#083344] py-16 px-4">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {services.map((service, idx) => (
            <div
              key={idx}
              className={`p-6 rounded-xl shadow-md bg-white text-left border-2 transition-transform hover:scale-105 ${
                service.highlight ? "bg-lime-100 border-lime-300" : ""
              }`}
            >
