...
// Center position of Bangladesh
const position = [23.685, 90.3563];

// Optional custom marker icon (can be skipped if not needed)
...
const BangladeshMap = ({ servicesCenter }) => {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    const district = servicesCenter.find((d) =>
    ...
    <div className="h-[600px] w-full rounded-lg overflow-hidden shadow-lg relative">
      ...
      >
        <input
          ...
          className="flex-1 px-4 py-2 border rounded-2xl outline-none"
          value={searchText}
